...
### **Workflow Access**
```bash
.github/workflows/ci-enhanced.yml -> ../../.claude/workflows/ci-enhanced.yml
.github/workflows/dashboard.yml -> ../../.claude/workflows/dashboard.yml
.github/workflows/security-analysis.yml -> ../../.claude/workflows/security-analysis.yml
.github/workflows/sonarcloud.yml -> ../../.claude/workflows/sonarcloud.yml
.github/workflows/update-review-patterns.yml -> ../../.claude/workflows/update-review-patterns.yml
```
