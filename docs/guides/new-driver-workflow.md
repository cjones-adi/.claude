...
> **💡 Enhanced Option:** For AI-assisted development with Claude Code, see [claude-code-integration-guide.md](claude-code-integration-guide.md) instead. This guide covers the **manual workflow** for developers preferring direct tool usage.
...
# For PMBus devices (you select specific commands manually)
